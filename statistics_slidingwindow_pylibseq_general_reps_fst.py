...
#python statistics_slidingwindow_pylibseq_general_reps_fst.py -winSize 500 -stepSize 500 -regionLen 10000 -numIndvPop1 100 -numIndvPop2 100 -input_folder /path/to/folder/with/ms/files -output_folder /path/to/results -output_prefix name_of_output_files
...
parser.add_argument('-output_prefix', dest = 'output_prefix', action='store', nargs = 1, type = str, help = 'prefix used for output files')
...
result.write("repID" + '\t' + "posn" + '\t' + "FST_HSM" + '\t' + "FST_Slatkin" + '\t' + "FST_HBK" + '\t' + "SNPs_shared" + '\t' + "SNPs_private1" + '\t' + "SNPs_private2" + '\t' + "Fixed_diff" + '\t' + "pop1_thetapi" + '\t' + "pop2_thetapi" + '\t' + "pop1_thetaw" + '\t' + "pop2_thetaw" + '\t' + "pop1_thetah" + '\t' + "pop2_thetah" + '\t' + "pop1_tajimasd" + '\t' + "pop2_tajimasd" + '\t' + "pop1_numsing" + '\t' + "pop2_numsing" + '\t' + "pop1_hapdiv" + '\t' + "pop2_hapdiv" + '\n')
    ...
    if numsim > 0:
        ...
        for i in range(len(w)):
            ...
            try:
                ...
                result.write("rep" + str(numsim) + '\t' + str(win_name) + '\t' + str(fwi.hsm()) + '\t' + str(fwi.slatkin()) + '\t' + str(fwi.hbk()) + '\t' + str(len(fwi.shared(0,1))) + '\t' + str(len(fwi.priv(0,1)[0])) + '\t' + str(len(fwi.priv(0,1)[1])) + '\t' + str(len(fwi.fixed(0,1))) + '\t')
            except:
                result.write("rep" + str(numsim) + '\t' + str(win_name) + '\t' + "NA" + '\t' + "NA" + '\t' + "NA" + '\t' + "NA" + '\t' + "NA" + '\t' + "NA" + '\t' + "NA" + '\t')
