...
#python statistics_slidingwindow_pylibseq_general_reps.py -winSize 100 -stepSize 100 -regionLen 10000 -input_folder /path/to/folder/with/ms/files -output_folder /path/to/folder/with/results -output_prefix name_of_result_files
...
result.write("repID" + '\t' + "filename" + '\t' + "posn" + '\t' + "S" + '\t' + "thetapi" + '\t' + "thetaw" + '\t' + "thetah" + '\t' + "hprime" + '\t' + "tajimasd" +  '\t' + "numSing" + '\t' + "hapdiv" + '\t' + "rsq" + '\t' + "D" + '\t' + "Dprime" + '\t' + "div" + '\n')
...
for line in f_list:
	...
	#print (l_Genos)
        ...
        for i in range(len(w)):
            ...
            result.write("rep" + str(numsim) + '\t' + f_name_file + '\t' + str(win_name) + '\t' + S + '\t' + str(pswi.thetapi()) + '\t' + str(pswi.thetaw()) + '\t' + str(pswi.thetah()) + '\t' + str(pswi.hprime()) + '\t' + str(pswi.tajimasd()) + '\t' + str(pswi.numexternalmutations()) + '\t' + str(pswi.hapdiv()) + '\t')
